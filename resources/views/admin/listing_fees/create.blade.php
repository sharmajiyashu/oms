                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form" action="{{ route('admin.listing_fees.store') }}" method="POST">
                                    {{ csrf_field() }}
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="first-name-column" name="title" class="form-control" placeholder="Listing Fee title" value="{{ old('title') }}" />
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="number" id="first-name-column" name="amount" class="form-control" placeholder="Listing Fee title" value="{{ old('title') }}" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="number" id="first-name-column" name="from_list" class="form-control" placeholder="Listing Fee title" value="{{ old('from_list') }}" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="number" id="first-name-column" name="to_list" class="form-control" placeholder="Listing Fee title" value="{{ old('to_list') }}" />
                                                </div>
                                            </div>
