                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="first-name-column" name="firstname" class="form-control" placeholder="First Name" value="{{ old('firstname') }}" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="first-name-column" name="lastname" class="form-control" placeholder="Last Name" value="{{ old('lastname') }}" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <textarea class="form-control" name="address" id="exampleFormControlTextarea1" rows="3" placeholder="Address">{{ old('address') }}</textarea>
                                                </div>
                                            </div>
