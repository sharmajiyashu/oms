                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header border-bottom">
                                    ...
                                    <!-- <button class=" btn btn-info btn-gradient round  ">Add User</button> -->
                                    <a href="{{url('admin/users/create')}}" class=" btn btn-info btn-gradient round  ">Add User</a>
                                </div>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <form action="{{route('admin.users.destroy',$val->id)}}" method="POST">
                                                                @csrf
                                                                @method('delete')
